...
```bash
# For AWS ECR (authenticate to AWS first)
...
> **Note:** CUDA extension compilation takes approximately 15-20 minutes. The Dockerfile sets `TORCH_CUDA_ARCH_LIST="8.0;8.6;8.9;9.0"` to support A100, A10/A40, L4/L40, and H100 GPUs.
