...
class SageMakerHyperPodConnectorAdapter(ConnectorAdapter):
    ...
    def __init__(self) -> None:
        super().__init__("sagemaker_hyperpod://")
    ...
    def create_connector(self, context: ConnectorContext) -> RemoteConnector:
        ...
        http_url = self._parse_url(context.url, use_https)

        logger.info(
            f"Creating SageMaker HyperPod connector: url={http_url}, "
        ...
        connector = SageMakerHyperPodConnector(
            sagemaker_hyperpod_url=http_url,
            loop=context.loop,
    ...
    def _parse_url(url: str, use_https: bool) -> str:
        ...
        Args:
            url: Raw URL from context (e.g., "sagemaker_hyperpod://127.0.0.1:9200")
        ...
        # Strip the sagemaker_hyperpod:// prefix
        raw_url = url.removeprefix("sagemaker_hyperpod://")

        assert raw_url, (
            "SageMaker HyperPod URL must contain host information after 'sagemaker_hyperpod://'"
        )
